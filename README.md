...
### Bản đồ Influence × Interest (Mức ảnh hưởng × Mức quan tâm)

Vị trí trên 2 trục quyết định **mức đầu tư công sức**; nhãn Champion/Blocker/Supporter/Bystander mô tả **thái độ hiện tại** của stakeholder đó.

| Stakeholder | Influence | Interest | Ô trên ma trận | Nhãn |
| :--- | :---: | :---: | :--- | :--- |
| Hiệu trưởng | Cao | Cao | Quản lý sát sao | **Champion** |
| Thủ thư trường học | Cao | Cao | Quản lý sát sao | **Blocker** |
| Nhân viên IT (quản trị kỹ thuật) | Cao | Thấp | Giữ hài lòng | **Blocker** |
| Sinh viên | Thấp | Cao | Giữ thông tin đều | **Supporter** |
| Bộ phận đào tạo | Thấp | Cao | Giữ thông tin đều | **Supporter** |
| Ban quản lý tài sản (sách, thiết bị) | Thấp | Thấp | Theo dõi tối thiểu | **Bystander** |

**Ý nghĩa 4 nhãn:**
- **Champion** — ảnh hưởng cao + ủng hộ mạnh → nhờ mở đường, tạo áp lực tích cực lên các phòng ban.
- **Blocker** — ảnh hưởng cao + đang e ngại/phản đối → ưu tiên thuyết phục số 1.
- **Supporter** — quan tâm cao nhưng ảnh hưởng thấp → nuôi dưỡng, lấy feedback và bằng chứng sử dụng.
- **Bystander** — thấp ở cả hai trục → chỉ thông báo tối thiểu, không tốn nguồn lực.

- **4 stakeholder ưu tiên hành động (1–2 tuần tới):**
    + Hiệu trưởng — Champion
    + Thủ thư trường học — Blocker (ưu tiên số 1)
    + Nhân viên IT (quản trị kỹ thuật) — Blocker
    + Sinh viên — Supporter
